...
#ifndef BASESCRIPTCOMPONENT_H
#define BASESCRIPTCOMPONENT_H
...
{
	eastl::string m_scriptObjectName;
    eastl::string m_constructorName;
    eastl::string m_destructorName;
...
public:
	...
	virtual bool Init(XmlElement* pData);
...
private:
    ...
    float GetYOrientationDegrees(void) const;
