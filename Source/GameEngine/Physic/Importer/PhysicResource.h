...
#ifndef PHYSICRESOURCE_H
#define PHYSICRESOURCE_H

#include "GameEngineStd.h"

#include "Core/IO/ResourceCache.h"

#include "Bsp/BspLoader.h"

class BspResourceExtraData : public BaseResourceExtraData
{

public:
    virtual eastl::wstring ToString() { return L"BspResourceExtraData"; }
	virtual BspLoader& GetLoader() { return mLoader; }
	virtual void SetLoader(BspLoader& loader) { mLoader = loader; }
...
class PhysicResourceLoader : public BaseResourceLoader
{
public:
