...
#ifndef UINTEGERAP32_H
#define UINTEGERAP32_H
...
// regularly with eastl::vector<uint32_t> during BSNumber operations.  A safer
...
//
//#define GE_COLLECT_UINTEGERAP32_STATISTICS
...
public:
    ...
    inline eastl::vector<uint32_t> const& GetBits() const;
    inline eastl::vector<uint32_t>& GetBits();
...
inline eastl::vector<uint32_t> const& UIntegerAP32::GetBits() const
{
    return mBits;
}

inline eastl::vector<uint32_t>& UIntegerAP32::GetBits()
{
    return mBits;
}
