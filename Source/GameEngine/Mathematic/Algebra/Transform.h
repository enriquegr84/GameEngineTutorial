...
// Transforms when using the convention GE_USE_MAT_VEC.
//
...
// Transforms when using the convention GE_USE_VEC_MAT.
//
...
// With either multiplication convention, a matrix M = R*S (GE_USE_MAT_VEC)
// or a matrix M = S*R (GE_USE_VEC_MAT) is referred to as an "RS-matrix".
