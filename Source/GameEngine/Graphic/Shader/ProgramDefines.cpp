...
void ProgramDefines::Update(eastl::string const& name, eastl::string const& value)
{
    ...
    mDefinitions.push_back(eastl::make_pair(name, value));
}

void ProgramDefines::Remove(eastl::string const& name)
{
