...
#ifndef POINTLIGHTTEXTUREEFFECT_H
#define POINTLIGHTTEXTUREEFFECT_H

#include "LightingEffect.h"
#include "Graphic/Resource/Texture/Texture2.h"


class GRAPHIC_ITEM PointLightTextureEffect : public LightingEffect
{
public:
    // Construction.
...
inline eastl::shared_ptr<Texture2> const& PointLightTextureEffect::GetTexture() const
{
    return mTexture;
}

inline eastl::shared_ptr<SamplerState> const& PointLightTextureEffect::GetSampler() const
{
    return mSampler;
}
