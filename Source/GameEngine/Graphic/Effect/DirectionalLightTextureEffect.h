...
#ifndef DIRECTIONALLIGHTTEXTUREEFFECT_H
#define DIRECTIONALLIGHTTEXTUREEFFECT_H
...
class GRAPHIC_ITEM DirectionalLightTextureEffect : public LightingEffect
{
public:
    // Construction.
...
inline eastl::shared_ptr<Texture2> const& DirectionalLightTextureEffect::GetTexture() const
{
    return mTexture;
}

inline eastl::shared_ptr<SamplerState> const& DirectionalLightTextureEffect::GetSampler() const
{
    return mSampler;
}
