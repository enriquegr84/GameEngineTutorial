...
#ifndef TEXTURE2COLOREFFECT_H
#define TEXTURE2COLOREFFECT_H
...
class GRAPHIC_ITEM Texture2ColorEffect : public VisualEffect
{
public:
    // Constructionn.
...
inline void Texture2ColorEffect::SetPVWMatrix(Matrix4x4<float> const& pvwMatrix)
{
    *mPVWMatrix = pvwMatrix;
}

inline Matrix4x4<float> const& Texture2ColorEffect::GetPVWMatrix() const
{
    return *mPVWMatrix;
}
...
inline eastl::shared_ptr<Texture2> const& Texture2ColorEffect::GetTexture() const
{
    return mTexture;
}

inline eastl::shared_ptr<SamplerState> const& Texture2ColorEffect::GetSampler() const
{
    return mSampler;
}
