...
eastl::string const TextEffect::msGLSLVSSource =
"uniform Translate\n"
"{\n"
"    vec2 translate;\n"
"};\n"
...
eastl::string const TextEffect::msGLSLPSSource =
"uniform TextColor\n"
"{\n"
"    vec4 textColor;\n"
"};\n"
...
eastl::string const TextEffect::msHLSLSource =
"cbuffer Translate\n"
"{\n"
"    float2 translate;\n"
"};\n"
...
eastl::string const* TextEffect::msVSSource[] =
{
    &msGLSLVSSource,
    &msHLSLSource
};

eastl::string const* TextEffect::msPSSource[] =
{
    &msGLSLPSSource,
    &msHLSLSource
};
