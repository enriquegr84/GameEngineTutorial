...
#ifndef POINTLIGHTEFFECT_H
#define POINTLIGHTEFFECT_H

#include "LightingEffect.h"

class GRAPHIC_ITEM PointLightEffect : public LightingEffect
{
public:
    // Construction. Set 'select' to 0 for per-vertex effects or to 1 for per-pixel effects.
    PointLightEffect(eastl::shared_ptr<ProgramFactory> const& factory, 
