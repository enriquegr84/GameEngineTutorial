...
class GRAPHIC_ITEM TextureArray : public Texture
{
protected:
...
typedef eastl::function<void(eastl::shared_ptr<TextureArray> const&)> TextureArrayUpdater;
typedef eastl::function<void(eastl::shared_ptr<TextureArray> const&, unsigned int)> TextureArrayLevelUpdater;
