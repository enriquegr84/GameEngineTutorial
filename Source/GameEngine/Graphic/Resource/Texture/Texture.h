...
class GRAPHIC_ITEM Texture : public Resource
{
protected:
...
protected:
    ...
    eastl::array<eastl::array<unsigned int, 3>, MAX_MIPMAP_LEVELS> mLDimension;
	eastl::array<unsigned int, MAX_MIPMAP_LEVELS> mLNumBytes;
	eastl::vector<eastl::array<unsigned int, MAX_MIPMAP_LEVELS>> mLOffset;
    bool mHasMipmaps;
    bool mAutogenerateMipmaps;
};

typedef eastl::function<void(eastl::shared_ptr<Texture> const&)> TextureUpdater;
typedef eastl::function<void(eastl::shared_ptr<Texture> const&, unsigned int)> TextureLevelUpdater;
