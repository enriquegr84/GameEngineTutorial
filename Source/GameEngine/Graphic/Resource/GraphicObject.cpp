...
void GraphicObject::SubscribeForDestruction(eastl::shared_ptr<ListenerForDestruction> const& listener)
{
    msLFDMutex.lock();
    {
...
void GraphicObject::UnsubscribeForDestruction(eastl::shared_ptr<ListenerForDestruction> const& listener)
{
    msLFDMutex.lock();
    {
