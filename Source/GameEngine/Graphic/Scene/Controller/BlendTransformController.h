...
#ifndef BLENDTRANSFORMCONTROLLER_H
#define BLENDTRANSFORMCONTROLLER_H

#include "TransformController.h"

class GRAPHIC_ITEM BlendTransformController : public TransformController
{
public:
    ...
    BlendTransformController(
		eastl::shared_ptr<TransformController> const& controller0,
		eastl::shared_ptr<TransformController> const& controller1,
        bool geometricRotation, bool geometricScale);

    // Member access.  The weight w is a number for which 0 <= w <= 1.
    inline eastl::shared_ptr<TransformController> const& GetController0() const;
    inline eastl::shared_ptr<TransformController> const& GetController1() const;
...
protected:
	...
	eastl::shared_ptr<TransformController> mController0, mController1;
    float mWeight;
    bool mRSMatrices, mGeometricRotation, mGeometricScale;
};


inline eastl::shared_ptr<TransformController> const&
