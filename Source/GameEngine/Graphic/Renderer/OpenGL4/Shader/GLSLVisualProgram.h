...
#ifndef GLSLVISUALPROGRAM_H
#define GLSLVISUALPROGRAM_H
...
// be done in GLSLProgramFactory, Engine-required data packaged in the
...
class GRAPHIC_ITEM GLSLVisualProgram : public VisualProgram
{
public:
