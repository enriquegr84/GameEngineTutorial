    ...
    GL4Texture(gtTexture, target, targetBinding)
{
    ...
    eastl::fill(std::begin(mLevelPixelUnpackBuffer), std::end(mLevelPixelUnpackBuffer), 0);
    eastl::fill(std::begin(mLevelPixelPackBuffer), std::end(mLevelPixelPackBuffer), 0);
}
