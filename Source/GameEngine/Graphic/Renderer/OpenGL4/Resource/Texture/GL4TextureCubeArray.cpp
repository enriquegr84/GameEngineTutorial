...
eastl::shared_ptr<GraphicObject> GL4TextureCubeArray::Create(void*, GraphicObject const* object)
{
    if (object->GetType() == GE_TEXTURE_CUBE_ARRAY)
    {
        return eastl::make_shared<GL4TextureCubeArray>(
