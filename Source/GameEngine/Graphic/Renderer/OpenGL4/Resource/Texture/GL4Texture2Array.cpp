...
eastl::shared_ptr<GraphicObject> GL4Texture2Array::Create(void*, GraphicObject const* object)
{
    if (object->GetType() == GE_TEXTURE2_ARRAY)
    {
        return eastl::make_shared<GL4Texture2Array>(
