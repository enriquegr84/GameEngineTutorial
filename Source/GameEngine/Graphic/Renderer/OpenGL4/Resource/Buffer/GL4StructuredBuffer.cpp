...
eastl::shared_ptr<GraphicObject> GL4StructuredBuffer::Create(void*, GraphicObject const* object)
{
    if (object->GetType() == GE_STRUCTURED_BUFFER)
    {
        return eastl::make_shared<GL4StructuredBuffer>(
