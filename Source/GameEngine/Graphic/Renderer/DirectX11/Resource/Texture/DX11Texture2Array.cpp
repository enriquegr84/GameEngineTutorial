...
eastl::shared_ptr<GraphicObject> DX11Texture2Array::Create(void* device, GraphicObject const* object)
{
    if (object->GetType() == GE_TEXTURE2_ARRAY)
    {
        return eastl::make_shared<DX11Texture2Array>(
