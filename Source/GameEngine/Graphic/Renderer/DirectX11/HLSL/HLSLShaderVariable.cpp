...
{
    mDesc.name = eastl::string(desc.Name ? desc.Name : "");
...
eastl::string const& HLSLShaderVariable::GetName() const
{
    return mDesc.name;
}
...
eastl::vector<unsigned char> const& HLSLShaderVariable::GetDefaultValue() const
{
