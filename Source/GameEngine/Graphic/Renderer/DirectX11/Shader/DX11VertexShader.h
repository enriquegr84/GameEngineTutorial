...
#ifndef DX11VERTEXSHADER_H
#define DX11VERTEXSHADER_H

#include "Graphic/Shader/Shader.h"
#include "DX11Shader.h"

/*
	Vertex Shader Stage (VS) processes the primitives interpreted by the
	input-assembler stage. It does this processing on a per-vertex basis and
	is the first stage in the pipeline that is programmable
*/
class GRAPHIC_ITEM DX11VertexShader : public DX11Shader
{
public:
    // Construction.
