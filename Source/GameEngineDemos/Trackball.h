...
public:
    ...
    // desired.
    Trackball();
    Trackball(int xSize, int ySize, eastl::shared_ptr<Camera> const& camera);
    ...
    inline eastl::shared_ptr<Node> const& GetRoot() const;
    ...
    // system.
    void Attach(eastl::shared_ptr<Spatial> const& object);
    void Detach(eastl::shared_ptr<Spatial> const& object);
    void DetachAll();
...
inline eastl::shared_ptr<Camera> const& Trackball::GetCamera() const
{
    return mCamera;
}

inline eastl::shared_ptr<Node> const& Trackball::GetRoot() const
{
	return mRoot;
}
