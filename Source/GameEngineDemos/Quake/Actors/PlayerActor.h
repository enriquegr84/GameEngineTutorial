...
enum ActionType
{
	...
	ACTION_CROUCH = 0x0000004,
	ACTION_JUMP = 0x000008,
	ACTION_RUN = 0x0000010,
	ACTION_MOVEFORWARD = 0x0000020,
	ACTION_MOVEBACK = 0x0000040,
	ACTION_MOVELEFT = 0x0000080,
	ACTION_MOVERIGHT = 0x0000100,
	ACTION_FALLEN = 0x0000200,
	ACTION_KNOCKBACK = 0x0000400
};
