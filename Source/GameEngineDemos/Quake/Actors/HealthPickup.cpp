//========================================================================
// HealthPickup.cpp - A health pickup
//
...
const char* HealthPickup::Name = "HealthPickup";

//---------------------------------------------------------------------------------------------------------------------
// HealthPickup
//---------------------------------------------------------------------------------------------------------------------
HealthPickup::HealthPickup(void)
{
	mRespawnTime = 0.f;
}
...
tinyxml2::XMLElement* HealthPickup::GenerateXml(void)
{
...
void HealthPickup::Apply(eastl::weak_ptr<Actor> pActor)
{
	eastl::shared_ptr<Actor> pStrongActor(pActor);
    if (pStrongActor)
    {
        LogInformation("Applying health pickup to actor id " + eastl::to_string(pStrongActor->GetId()));
    }
}

void HealthPickup::Update(float deltaMs)
{
