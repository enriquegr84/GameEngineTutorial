...
////////////////////////////////////////////////////
// QuakeCameraController Implementation
////////////////////////////////////////////////////
...
//
// QuakeCameraController::OnMouseButtonDown		- Chapter 10, page 282
//
bool QuakeCameraController::OnMouseButtonDown(
...
bool QuakeCameraController::OnMouseButtonUp(
	const Vector2<int> &mousePos, const int radius, const eastl::string &buttonName)
{
	if (buttonName == "PointerLeft")
	{
...
//  class QuakeCameraController::OnMouseMove		- Chapter 10, page 282
...
//  class QuakeCameraController::OnUpdate			- Chapter 10, page 283

void QuakeCameraController::OnUpdate(unsigned int timeMs, unsigned long deltaMs)
{
